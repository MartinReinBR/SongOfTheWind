...
public:	
	UFUNCTION()
	void HandleMotionBlur(bool IsEnabled);
	UFUNCTION()
	void HandleVSync(bool IsEnabled);
	...
	UPROPERTY(EditAnywhere)
	class UFG_DA_SettingsData* SettingsData;
	...
	UFUNCTION(BlueprintCallable)
	void SetTruckOffset(float Offset);
